...
function processWorkbookFile(filePath, fileName) {
  try {
    ...
    // Create workbook item with direct pass-through of the media object
    return {
      ...
      // Pass through the entire media object - no flattening
...
export function generateWorkbookData() {
  const workbookDir = path.join(__dirname, '../workbook');
