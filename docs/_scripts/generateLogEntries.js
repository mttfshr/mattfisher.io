// docs/_scripts/generateLogEntries.js
import fs from 'fs';
 ...
 */
const CACHE_PATH = path.join(__dirname, '../_cache/og-cache.json')
...
export async function generateLogData() {
  ...
  const OUTPUT_FILE = path.join(__dirname, '../.vitepress/data/logEntries.js')
